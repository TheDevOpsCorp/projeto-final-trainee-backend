...
import {  testsignJWT } from '../src/helpers/auth.js';
...
describe('AUTH TEST', () => {
    ...
    it('401: token deve expirar quando passar o tempo', async () => {
        const token = testsignJWT({ id: 1 }, { expiresIn: '1ms' });
        await supertest(test_app)
            .post(path)
